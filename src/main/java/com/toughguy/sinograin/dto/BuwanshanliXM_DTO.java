...
public class BuwanshanliXM_DTO {
	...
	private String kuangwuzhi;                        //矿物质（g）
	private String kuangwuzhizongliang_cedingzhi;     //矿物质总量（g）测定值
	...
	public String getKuangwuzhizongliang_cedingzhi() {
		return kuangwuzhizongliang_cedingzhi;
	}
	public void setKuangwuzhizongliang_cedingzhi(String kuangwuzhizongliang_cedingzhi) {
		this.kuangwuzhizongliang_cedingzhi = kuangwuzhizongliang_cedingzhi;
	}
