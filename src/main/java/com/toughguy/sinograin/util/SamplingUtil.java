...
public class SamplingUtil {
	...
	public static String sampleNum (String sort) throws Exception{
		...
		// String year = sdf.format(new Date());
		 ...
		 //String year = "2019";D:/eclipse/sinograin_backend/src/main/resources/config
	     FileInputStream fileInput = new FileInputStream("D:/eclipse/sinograin_backend/src/main/resources/config/grain.properties");
	     ...
	     OutputStream out = new FileOutputStream("D:/eclipse/sinograin_backend/src/main/resources/config/grain.properties");  
