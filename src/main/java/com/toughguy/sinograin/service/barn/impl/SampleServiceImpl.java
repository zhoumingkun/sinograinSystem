...
public class SampleServiceImpl extends GenericServiceImpl<Sample, Integer> implements ISampleService {
	...
	public Boolean result(String sampleNums,String smallSamples) {
		...
		HSSFSheet sheet = utils.sheet("汇总表");
...
//-------3行
		...
		for (int i = 0; i < sampleNum.length; i++) {
			...
			row7.createCell(18).setCellValue(Wobjiect.getUnQuality());
			row7.createCell(18).setCellValue(Wobjiect.getGrainQuality());
			row7.createCell(18).setCellValue(Wobjiect.getSlip());
			row7.createCell(19).setCellValue(Wobjiect1.getQualityGrade());
			row7.createCell(20).setCellValue(Wobjiect1.getShuifen_pingjunzhi());
			row7.createCell(21).setCellValue(Wobjiect1.getZazhizongliang_1());
			row7.createCell(22).setCellValue(Wobjiect1.getKuangwuzhihanliang_pingjunzhi());
			row7.createCell(23).setCellValue(Wobjiect1.getBuwanshanlihanliang_pingjunzhi_1());
			row7.createCell(24).setCellValue(Wobjiect1.getYingduzhishu_pingjunzhi());
			row7.createCell(25).setCellValue(Wobjiect1.getSezeqiwei_pingjunzhi());
			row7.createCell(26).setCellValue(Wobjiect1.getPingjunzhiganmianjinzhiliang());
			row7.createCell(27).setCellValue(Wobjiect1.getShimianjin_pingjunzhi());
			row7.createCell(28).setCellValue(Wobjiect1.getPinchangpingfenzhi());
		}
		try {
	...
	public HSSFSheet sheet(HSSFWorkbook wb){
		...
		HSSFCell cell4 = row1.createCell(29);
		cell4.setCellStyle(utils.StyleFour());
...
//		sheet.addMergedRegion(new CellRangeAddress(1, 1, 7, 7));
		...
		for (int i = 0; i < 30; i++) {
			if(i < 10){
				HSSFCell row2cell1 = row2.createCell(i);
				row2cell1.setCellStyle(utils.StyleOne1());
				row2cell1.setCellValue(column[i]);
			}
			else if(i < 14 && i > 9){
				HSSFCell row2cell1 = row2.createCell(i);
				row2cell1.setCellStyle(utils.StyleTwo1());
				row2cell1.setCellValue(column[i]);
			}
				...
				HSSFCell row2cell1 = row2.createCell(i);
				row2cell1.setCellStyle(utils.StyleThree1());
				row2cell1.setCellValue(column[i-3]);
			}
			else if(i == 29){
				HSSFCell row2cell1 = row2.createCell(i);
				row2cell1.setCellStyle(utils.StyleFour1());
				row2cell1.setCellValue(column[i-3]);
			}
		...
		row2cell28.setCellStyle(utils.StyleFour1());
		row2cell28.setCellValue("等级");

		HSSFCell row2cell29 = row3.createCell(30);
		row2cell29.setCellStyle(utils.StyleFour1());
		...
		for (int i = 30; i < 33; i++) {
			if(i < 33){
				...
				row2cell30.setCellStyle(utils.StyleFour1());
		...
		for (int i = 33; i < 35; i++) {
			...
			row2cell34.setCellStyle(utils.StyleFour1());
		...
		row2cell36.setCellStyle(utils.StyleFour1());
...
//		row2cell44.setCellValue("色泽气味");
		...
		row2cell46.setCellStyle(utils.StyleFour1());
		...
		row2cell47.setCellStyle(utils.Style());
